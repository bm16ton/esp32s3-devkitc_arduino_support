...
//R,G,B
GRGB led(COMMON_ANODE, PC9, PA8, PC7);
RF24 radio(PB6,PB7);
#endif
...
//sk.show();
  ...
  if (millis() - tmr >= 2000) {
    ...
    if (++mode >= 5) mode = 0;
    switch (mode) {
      case 0: led.setRGB(255, 0, 0);  
        break;
      case 1: led.setRGB(255, 0, 0, 50);  
        break;
      case 2: led.setColor(GBlue);    
        break;
      case 3: led.setColor(GRed); 
        break;
      case 4: led.setWheel8(30, 10);  
        break;
    }
   }
