...
#define HOSTNAME                                  "poop"
#include "./servers/network.h"              // some network telnet commands like "ping", "ifconfig", ... are also supported here

#define USER_MANAGEMENT NO_USER_MANAGEMENT  //UNIX_LIKE_USER_MANAGEMENT // HARDCODED_USER_MANAGEMENT // NO_USER_MANAGEMENT
#include "./servers/user_management.h"  
#include "./servers/ftpServer.hpp"                  // file_system.h is also necessary to use
...
//ESP32 connects to your wifi -----------------------------------
  ...
  ftpServer *ftpSrv = new ftpServer ((char *) "0.0.0.0",                    // start FTP server on all available ip addresses
                                     21,                                    // default FTP port
                                     NULL);                     // let's use firewallCallback function for FTP server
