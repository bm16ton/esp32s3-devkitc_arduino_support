...
<div class="card">
  ...
  <h1>A1 Value: <span id="ADCValue2">0</span>V</h1><br>
  <h1>A2 Value: <span id="ADCValue3">0</span>V</h1><br>
  <h1>A8 Value: <span id="ADCValue4">0</span>V</h1><br>
  <h1>A9 Value: <span id="ADCValue5">0</span>V</h1><br>
