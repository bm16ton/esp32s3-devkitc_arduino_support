...
int rc;
    ...
    _skstrip = (rmt_item32_t *)calloc(  _bitcount, sizeof( rmt_item32_t ) );
     ...
     skconfig.channel = RMT_CHANNEL_1;
...
//delay(50);
Serial2.printf("_brightness = %d, brightness %d, bright %d\n", _brightness, brightness, bright);
//Serial.printf( " " );
...
//delay(50);
Serial2.printf("Set color of led %d kleur %08X\n", led, kleur);
//Serial.printf( " " );
